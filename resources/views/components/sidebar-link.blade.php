...
<a {{ $attributes->merge(['class' => $classes]) }}>
    ...
    <span class="flex-shrink-0 w-6 h-6 flex items-center justify-center">
        @switch($icon)
            ...
            @case('users')
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                @break
            @case('carousel')
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
